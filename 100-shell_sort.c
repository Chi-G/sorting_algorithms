...
/**
 * find_pow - function that finds power of a number
 * @x: the number
...
/**
 * seq_generator - the generate sequence
 * @size: the size of sequence
 *
 * Return: the pointer to the address of sequence
 */
 ...
 * @sequence: the pointer to the address of sequence
 * @size: the size of sequence
 *
...
/**
 * shell_sort - functions that sorts using the Shell sort algorithm
