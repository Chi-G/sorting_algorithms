...
/**
 * arr_zero_init - function to initialize array by 0
 *
...
/**
 * get_max - function that gets the maximum value in the array
 *
...
/**
 * counting_sort - function that sorts an array using the counting
 * sort algorithm
 *
