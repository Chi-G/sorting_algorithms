...
/**
 * arr_zero_init - funct that initialize array by 0
 *
...
/**
 * get_max - func that gets the maximum value in the array
 *
...
/**
 * sort_counter - func that sorts an array using the counting_sort
...
/**
 * radix_sort - func that peforms the the LSD (least significant Digit)
